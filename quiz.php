        ...
        <img src="enviro_logo.png" alt="" class="m-2 rounded mx-auto d-block" width="50%">
            ...
            <div class="row p-3 button_area justify-content-center">
                <?php
                    for($x=1;$x<=10;$x++)
                    {
                        echo '<div class="col-4 p-0 mb-2 d-flex justify-content-center">
                            <button type="button" id="questionnumber'.$x.'" class="btn btn-dark border m-1 border-dark rounded-circle ques_num " style="width:50px;height:50px;" onclick="reach('.$x.')">'.$x.'</button>
                        </div>';
                    }
                ?>
            ...
            <div class="row p-4 d-flex align-items-center">
                <div class="bg-dark border border-dark rounded-circle mb-2" style="height:37px; width:37px;">
                </div>
                <div class="col-9 mb-2 pt-0 h6">
                    Not Visited
                </div>
                <div class="bg-danger border border-dark rounded-circle mb-2" style="height:37px; width:37px;">
                </div>
                <div class="col-9 mb-2 pt-0 h6">
                    Not Answered
                </div>
                <div class="bg-success border border-dark rounded-circle mb-2" style="height:37px; width:37px;">
                </div>
                <div class="col-9 mb-2 pt-0 h6">
                    Answered
                </div>
                <div class="bg-primary border border-dark rounded-circle mb-2" style="height:37px; width:37px;">
                </div>
                <div class="col-9 mb-2 pt-0 h6">
                    Marked for review
                </div>
